...
public class TunerConstants {
    ...
    private static final TalonFXConfiguration driveInitialConfigs = new TalonFXConfiguration()
        .withCurrentLimits(
            new CurrentLimitsConfigs()
                // Supply current limit caps battery draw to prevent brownouts when accelerating.
                // Allow a brief 60 A burst for launch, then settle to 40 A sustained.
                // (Stator is limited separately via kSlipCurrent.)
    ...
    private static final double kCoupleRatio = 3.125 * 14 /12;

    private static final double kDriveGearRatio = 7.125;
    private static final double kSteerGearRatio = 225 / 14.0;//18.75;
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.18408203125);
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(0.050537109375);
     ...
     */
   public static frc.robot.subsystems.drive.CommandSwerveDrivetrain createDrivetrain() {
        return new frc.robot.subsystems.drive.CommandSwerveDrivetrain(
